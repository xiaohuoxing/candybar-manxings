		...
		if(keyFont != ""){			
			for(i=0;i<falseWords.length;i++){
				...
				//if(moren=="软件"){				
					...
					// window.location.href="http://www.yx007.com/so/m/?k="+encodeURI(keyFont);	
					window.location.href="http://www.cshbl.com/so/m/?k="+encodeURI(keyFont);	// 2023-08-11
				//}else{
